...
[![Badge License: GPLv3](https://img.shields.io/badge/License-GPLv3-brightgreen.svg)](https://www.gnu.org/licenses/gpl-3.0)
 &nbsp; &nbsp;
[![Badge Version](https://img.shields.io/github/v/release/ArminJo/Arduino-Utils?color=yellow&logo=DocuSign&logoColor=white)](https://github.com/ArminJo/Arduino-Utils/releases/latest)
 &nbsp; &nbsp;
...
* [ToneUtils](https://github.com/ArminJo/Arduino-Utils?tab=readme-ov-file#toneutils)
...
- The output of DoubleLowpass3 and 4 resembles a delayed sine the higher the frequency is.
...
Note the **different attenuation** at different frequencies and the **different phase shifts** of the filters.
<br/><br/>
...
4. All modules:<br/>
   ...
   [Another Arduino HCSR04 library](https://github.com/Martinsos/arduino-lib-hc-sr04).
...
[Another Arduino Dump library](https://github.com/neu-rah/Dump]
...
# ToneUtils
Lightweight implementation of Arduino `tone(Pin, Frequency)` function on pin 3 and 11 for ATmega328 (Uno, Nano etc.).
- Requires only **80 bytes program space** instead of **1500 bytes** when using Arduino `tone()`.
- Requires no interrupts.
- Restricted to prescaler 32 to 256, thus supporting only frequencies **from 244 Hz to 500 kHz**.
...
- Miscellaneous renaming and improvements.
